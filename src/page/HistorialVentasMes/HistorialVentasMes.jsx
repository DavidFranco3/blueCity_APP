...
import "./HistorialVentasMes.scss";
...
function HistorialVentasMes(props) {
    ...
    useEffect(() => {
                try {
                listarDetallesVentasPorMes(dia).then(response => {
                const { data } = response;
                ...
                setPage(1)
                        ...
                        listarPaginacionVentasMes(page, rowsPerPage, dia).then(response => {
                const { data } = response;
